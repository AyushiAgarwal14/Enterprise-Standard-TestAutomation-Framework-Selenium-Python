...
class ShellHubFunctions:
    ...
    def stay_signin_page(self):
        ...
        # print(username)
        BrowserUtilities.take_screenshot("Headless")
        status = SeleniumUtilities.is_element_displayed(self.shellHubControls.get_stay_sigin())
        return status
    ...
    def check_shell_hub_accessibility(self):
        print(BrowserUtilities.get_window_size())
        return AccessibilityUtilities.analyze_page()
    
    def trial(self):
        SeleniumUtilities.select_radiobutton()