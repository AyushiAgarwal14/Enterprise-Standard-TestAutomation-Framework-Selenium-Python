...
class ShellHubControls:
    ...
    stay_sigin = (By.XPATH, "//input[@id='idSIButton9']")
    display_name = (By.XPATH, "//div[@id='displayName']")

    def get_stay_sigin(self):
        return self.driver.find_element(*ShellHubControls.stay_sigin)

    def get_search_box(self):
        ele = self.driver.find_element(*ShellHubControls.search_box)
        BrowserUtilities.take_screenshot_of_element(ele, "Search-Box")
        return ele
