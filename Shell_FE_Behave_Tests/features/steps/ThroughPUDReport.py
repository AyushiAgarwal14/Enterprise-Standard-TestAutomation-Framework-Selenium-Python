...
def step_impl(context):
    ...
    context.forecast_function.click_ThroughPUD_report()
...
@When('user selects the desired report options in ThroughPUD Report')
def step_impl(context):
    ...
    context.forecast_function.click_Report_Objectives_with_Non_Res_Dev_SubClass()
    context.forecast_function.click_Split_by_SubClass()
