@web @R06.02_2P_ReservesReport
Feature: R06.02_2P_Reserves Report
    Scenario: open Rs1 and run the R06.02_2P_Reserves report
        ...
        And user selects the desired report options in R06.02_2P_Reserves Report
